...
const tabMenu = [
  { title: '기본 정보', key: 'basic' ,link:'./profile_edit/page/basic.tsx'},
  { title: '스킬', key: 'skill' },
...
export default function ProfileEdit() {
  ...
  return (
    <div className=" h-screen flex flex-col justify-center items-center">
      <main style={{"grid-template-rows":"1fr 0.5fr 4fr 0.7fr"}} className="bg-white shadow-md w-[600px] p-[48px] h-[698px] flex flex-col grid justify-center items-center gap-7 rounded-2xl">
        ...
        <div>
          <ul className="  h-[43px] w-full flex flex-row  text-[#454545] font-bold text-lg ">
            {tabMenu.map((tab) => (
              <li key={tab.key}>
                <div className=" h-full w-[125px] flex flex-col items-center">
