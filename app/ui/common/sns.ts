...
export const snsIcons={
    youtube:{on:{normal:YoutubeOn, clicked:YoutubeOnClicked},off:{normal:YoutubeOff, clicked:YoutubeOffClicked}},
    instagram:{on:{normal:InstagramOn, clicked:InstagramOnClicked},off:{normal:InstagramOff, clicked:InstagramOffClicked}},
    facebook:{on:{normal:FacebookOn, clicked:FacebookOnClicked},off:{normal:FacebookOff, clicked:FacebookOffClicked}},
    linkedin:{on:{normal:LinkedinOn, clicked:LinkedinOnClicked},off:{normal:LinkedinOff, clicked:LinkedinOffClicked}},
    discord:{on:{normal:DiscordOn, clicked:DiscordOnClicked},off:{normal:DiscordOff, clicked:DiscordOffClicked}},
    behance:{on:{normal:BehanceOn, clicked:BehanceOnClicked},off:{normal:BehanceOff, clicked:BehanceOffClicked}},
    github:{on:{normal:GithubOn, clicked:GithubOnClicked},off:{normal:GithubOff, clicked:GithubOffClicked}},
}